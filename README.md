...
### DevOps Engineer | 5 Years of Professional Experience in Software Engineering
&nbsp;

DevOps Engineer with 5 years of experience as a Full-Stack Developer designing and shipping end-to-end web applications. Solid technical background across Linux, infrastructure-as-code (Terraform, Ansible), container platforms (Docker, ECS, Kubernetes), CI/CD operations (GitHub Actions, GitLab CI, Jenkins), observability stack (Prometheus, Grafana, Loki, Tempo, OpenTelemetry), and cloud ecosystems (AWS, DigitalOcean, Vercel) with strong scripting fundamentals in Python and Bash.
